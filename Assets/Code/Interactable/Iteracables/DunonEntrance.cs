...
[CreateAssetMenu(fileName = "Dunon", menuName = "TilesSet/Dungon Interactable")]
public class DunonEntrance : Interactable
{
    ...
    public override void OnInteract(Vector3Int tilePosition, GameObject player)
    {
            ...
            Debug.Log($"Loading dungeon: {dungeonName}");
            SceneLoader.Instance.LoadScene(dungeonName);
            SceneLoader.Instance.HideScene("Map");

            // Teleport player above the entrance door
